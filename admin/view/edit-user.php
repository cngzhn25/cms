...
<head>
    ...
    <link href="../public/global_assets/css/icons/icomoon/styles.min.css" rel="stylesheet" type="text/css">
    <link href="../public/admin/assets/css/all.min.css" rel="stylesheet" type="text/css">
    <!-- /global stylesheets -->
    ...
    <!-- Theme JS files -->
    <script src="../public/global_assets/js/plugins/forms/wizards/steps.min.js"></script>
    <script src="../public/global_assets/js/plugins/forms/inputs/inputmask.js"></script>
    <script src="../public/global_assets/js/plugins/forms/validation/validate.min.js"></script>
    <script src="../public/global_assets/js/plugins/extensions/cookie.js"></script>

    <script src="../public/admin/assets/js/app.js"></script>
    <script src="../public/global_assets/js/demo_pages/form_wizard.js"></script>
    <!-- /theme JS files -->
                ...
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item nav-item-submenu">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                            ...
                            <li class="nav-item"><a href="../../../../layout_3/LTR/dark/full/index.html" class="nav-link">Layout 3</a></li>
                            <li class="nav-item"><a href="../../../../layout_4/LTR/dark/full/index.html" class="nav-link">Layout 4</a></li>
                            <li class="nav-item"><a href="../../../../layout_5/LTR/dark/full/index.html" class="nav-link">Layout 5</a></li>
                            <li class="nav-item"><a href="../../../../layout_6/LTR/dark/full/index.html" class="nav-link">Layout 6</a></li>
                    ...
                    <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Form components">
                            ...
                            <li class="nav-item"><a href="form_wizard.html" class="nav-link active">Form wizard</a></li>
                    ...
                    <li class="nav-item nav-item-submenu">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Color system">
                            ...
                            <li class="nav-item"><a href="colors_light.html" class="nav-link">Light palette</a></li>
                            <li class="nav-item-divider"></li>
